      ...
      <NoteState>  
        ...
        <Router>
          ...
          <div className="container">
            ...
            <Routes> 
              <Route exact path="/" element={<Home showAlert={showAlert} />} />  {/* this will render on the click on home tab of the navbar,how route to add home page to the website  and it will fetch,delete all the data from the database  */}
              ...
              <Route exact path="/login" element={<Login showAlert={showAlert} />} />{/*This will render when we will click on the about section, this is about section by which we will show case our about section in the website and it will not perform any type of crud operation to our database */}
              <Route exact path="/signup" element={<Signup showAlert={showAlert}/>} />{/*This will render when we will click on the about section, this is about section by which we will show case our about section in the website and it will not perform any type of crud operation to our database */}
